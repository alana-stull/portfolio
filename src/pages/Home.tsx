...
export function Home() {
  ...
  const renderProjectImage = (studyId: string, title: string) => {
    switch (studyId) {
      case 'noted-by-nani':
        return (
          <div className="aspect-[4/3] rounded-2xl mb-8 overflow-hidden flex items-center justify-center">
      ...
      case 'blyss':
        return (
          <div className="aspect-[4/3] rounded-2xl mb-8 overflow-hidden flex items-center justify-center p-6">
      ...
      default:
        return (
          <div className="aspect-[4/3] rounded-2xl mb-8 overflow-hidden">
            <ImageWithFallback
